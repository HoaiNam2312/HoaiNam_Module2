        ...
        do {
            ...
            switch (luaChon) {
                ...
                case 2:
                    ...
                    int indexOfId = quanLySanPham.kiemTraId(idSuaDoi);
                    if (indexOfId != -1){
                        System.out.println("Nhập ID của sản phẩm: ");
                        ...
                        quanLySanPham.suaThongTinSanPham(sanPhamMoi,indexOfId);
                    }else {
                ...
                case 3:
                    ...
                    int indexOfIdXoa = quanLySanPham.kiemTraId(idXoa);
                    if (indexOfIdXoa != -1) {
                        quanLySanPham.xoaSanPham(indexOfIdXoa);
                    } else {
                        quanLySanPham.xoaSanPham(indexOfIdXoa);
                    }
                    break;
                ...
                case 5:
                    ...
                    int indexNameSearch = quanLySanPham.kiemTraName(nameSearch);
                    if (indexNameSearch != 1) {
                        quanLySanPham.timKiemSanPhamTheoTen(indexNameSearch);
                    } else {
