...
import Bai_Tap_Lon.utils.AccountDuplicateException;
import Bai_Tap_Lon.utils.IDInvalidException;
...
public class RegexData {
    ...
    public static String regexCCCD1(String input, Map<AccountLessor,String> lessorMap) {
        ...
        do {
            ...
            } catch (IDInvalidException | AccountDuplicateException e) {
                System.out.println(e.getMessage());
                input = sc.nextLine();
            }
        } while (check);
